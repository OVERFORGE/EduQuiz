...
$query = "SELECT * FROM `user_signup` WHERE `name` LIKE '%$search%' OR `id` LIKE '%$search%' OR `email` LIKE '%$search%' OR `password` LIKE '%$search%' LIMIT $start_limit,$offset";
$resultsearch = mysqli_query($conn, $query);

$count_query = "SELECT COUNT(*) as count FROM `user_signup` WHERE `name` LIKE '%$search%' OR `id` LIKE '%$search%' OR `email` LIKE '%$search%' OR `password` LIKE '%$search%'";
