...
$subject_id = isset($_REQUEST['subject']) ? $_REQUEST['subject'] : null;
    ...
    <div class="main-page-dashboard">
        ...
        <div class="main-content" id="main-content">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                ?>
                <a href="website_process.php?quiz_id=<?php echo $row['id']?>&mode=set_quiz_banner">
