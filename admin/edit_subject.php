    ...
    <div class="main-page-dashboard">
        ...
        <div class="main-content" id="main-content">
            ...
            <form id="signup-form" action="process.php" method="post" enctype="multipart/form-data">
                <h1 id="add-heading">Edit Subject</h1>
                <input type="hidden" name="id" value="<?php echo $row['id'];?>">
                <input type="hidden" name="mode" value="edit_subject" >
                <div class="form-group">
                    <label for="name">Subject Name:</label>
                    <input type="text" name="name" placeholder="Enter Class Name"  value="<?php echo  $row['subject_name']?>">
                </div>
                <div class="form-group">                   
