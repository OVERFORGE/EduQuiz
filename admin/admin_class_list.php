...
$query = "SELECT * FROM `class` WHERE `class_name` LIKE '%$search%' OR `id` LIKE '%$search%' LIMIT $start_limit,$offset";
$resultsearch = mysqli_query($conn, $query);

$count_query = "SELECT COUNT(*) as count FROM `class` WHERE `class_name` LIKE '%$search%' OR `id` LIKE '%$search%'";
    ...
    <div class="main-page-dashboard">
        ...
        <div class="main-content" id="main-content">
            ...
            <div class="export-and-add-section">
                ...
                <a href="add_to_class.php">Add Class</a>
            </div>
                        ...
                        if ($resultsearch && mysqli_num_rows($resultsearch) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($resultsearch)) {
                                ...
                                <tr>
                                    ...
                                    <td><img src="assets/images/<?php echo $row['class_img']; ?>" width="150px"></td>
                                    <td><?php echo $row['doe']; ?></td>
                                    <td><a href="edit_class.php?id=<?php echo $row['id']; ?>"><i class="fa fa-edit" style="font-size:24px"></a></td>
                                    <td><a href="process.php?id=<?php echo $row['id']; ?>&mode=delete_class" onclick="return confirm('Do want to delete?')"><i class="fa fa-trash-o" style="font-size:24px"></a></td>
                                </tr>
                                <?php
                            }
                            ?>
