...
<body>
    <div class="main-page-dashboard">
        ...
        <div class="main-content" id="main-content">
            ...
            <div class="class-card-holder">
            <?php while($row=mysqli_fetch_assoc($result)){?>
                <a href="subject_page.php?class=<?php echo $row['id']?>">
                    <div class="class-card">
                        <img src="admin/assets/images/<?php echo $row['class_img']?>" alt="">
                    </div>
                </a>
                <?php };
            ?>
