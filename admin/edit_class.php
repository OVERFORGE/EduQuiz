    ...
    <div class="main-page-dashboard">
        ...
        <div class="main-content" id="main-content">
            ...
            <form id="signup-form" action="process.php" method="post" enctype="multipart/form-data">
                <h1 id="add-heading">Edit Class</h1>
                <input type="hidden" name="id" value="<?php echo $row['id'];?>">
                <input type="hidden" name="mode" value="edit_class" >
                <div class="form-group">
                    <label for="name">Class Name:</label>
                    <input type="text" name="name" placeholder="Enter Class Name"  value="<?php echo  $row['class_name']?>">
                </div>
                <div class="form-group">
                ...
                <img scr="./assets/images/<?php echo $row['class_img']?>" width="350px" height="200px" >
